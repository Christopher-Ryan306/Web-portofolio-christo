...
<div class="admin-page" style="padding-top: 80px;">
    <div class="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 class="text-3xl font-bold mb-8">Tambah Project Baru</h1>
        ...
        <form method="POST" action="{{ route('admin.portfolio.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex gap-4">
                <button type="submit" class="px-6 py-2 bg-sky-600 rounded-lg hover:bg-sky-700 transition">Simpan</button>
